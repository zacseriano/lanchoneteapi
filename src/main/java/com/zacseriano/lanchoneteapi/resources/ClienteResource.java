...
import com.zacseriano.lanchoneteapi.models.item.ItemForm;
...
public class ClienteResource {
	...
	public Pedido salvaPrimeiroItem(@RequestBody @Valid ItemForm itemForm) {
	...
	public Pedido salvaOutroItem(@RequestBody ItemForm itemForm) {
